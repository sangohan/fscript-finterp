...
class FInterp {
    ...
    */
    private var context         : hxasm.Context;
    ...
    */
    public function execute(e : Expr, onComplete : Dynamic -> Void) {
        ...
        var className   = CLASS_NAME + Std.string(instanceNum);
        
        context         = new hxasm.Context();
        ...
        while (funcs.length > 0) handleFunction(funcs.pop());
        
        context.finalize();
        var out         = new haxe.io.BytesOutput();
        hxasm.Writer.write(out, context);
        ...
        loader.contentLoaderInfo.addEventListener(Event.COMPLETE, 
            function(_) {
                ...
                var c       = domain.getDefinition(className);
    ...
    function expr(e : Expr) {
        switch (e) {
            ...
            */
            ...
            //not sure how to handle a try block in hxasm
            /*
